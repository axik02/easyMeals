...
class PhotoHandler: NSObject{
    ...
    //MARK: - Constants
    struct Constants {
        static let actionFileTypeHeading = "Add Photo"
    ...
    func showAttachmentActionSheet(vc: UIViewController) {
        currentVC = vc
        let actionSheet = UIAlertController(title: Constants.actionFileTypeHeading, message: nil, preferredStyle: .actionSheet) //Constants.actionFileTypeDescription
