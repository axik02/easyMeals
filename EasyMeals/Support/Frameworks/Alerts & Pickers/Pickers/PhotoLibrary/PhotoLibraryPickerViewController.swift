...
extension UIAlertController {
    ...
    func addPhotoLibraryPicker(flow: UICollectionView.ScrollDirection, paging: Bool, selection: PhotoLibraryPickerViewController.Selection) {
        ...
        let buttonAdd = UIAlertAction(title: "Upload existing", style: .default) { action in
            switch selection {
        ...
        if UIDevice.current.userInterfaceIdiom == .pad {
            ...
            vc.preferredContentSize.height = vc.preferredSize.height - 120
        }
...
//            vc.preferredContentSize.width = vc.preferredSize.width * 0.9
//        } else {
//            vc.preferredContentSize.height = vc.preferredSize.height //100
//        }
//
//        addAction(buttonAdd)
//        set(vc: vc)
...
//        switch layout.scrollDirection {
//        case .vertical:
//            return CGSize(width: collectionView.bounds.width / columns - 10, height: collectionView.bounds.width / columns - 10)
//        case .horizontal:
//            return CGSize(width: view.bounds.width / 4, height: view.bounds.height / columns - 20)
//        }
//    }
//
//    // MARK: Properties
...
//        Assets.resolve(asset: asset, size: item.bounds.size) { new in
//            item.imageView.image = new
//            item.imageView.layer.cornerRadius = 5
